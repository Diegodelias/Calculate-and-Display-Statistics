...
function getArrayMembers(){
    ...
    function tablaML(nrotabla, array) {
        ...
        <tr>  
            ...
            <td class="text-center"> ${Math.round(element.total_votes*element.missed_votes_pct/100)}</td>
            <td class="text-center">${element.missed_votes_pct +"%"}</td>
    ...
    function tablas(){
        ...
        <tr>  
            ...
            <td class="text-center"> ${statistics.number_of_republicans}</td>
            <td class="text-center">${Math.round(statistics.republicansAvgVotParty)+ "%"}</td>
           
        </tr>
    
        <tr>  
            
            <td class="text-center">${"Democrats"}</td>
            <td class="text-center"> ${statistics.number_of_democrats}</td>
            <td class="text-center">${Math.round(statistics.democratsAvgVotParty)+"%"}</td>
        ...
        <tr>  
            ...
            <td class="text-center">${"Independents"}</td>
            <td class="text-center"> ${statistics.number_of_independents}</td>
            <td class="text-center">${Math.round(statistics.independentsAvgVotParty)+"%"}</td>
